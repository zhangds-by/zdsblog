...
import com.zhangds.zdsblog.common.utils.DateUtils;
import com.zhangds.zdsblog.common.utils.Md5Utils;
...
public class FileUploadUtils
{
    ...
    public static final String upload(String baseDir, MultipartFile file, String[] allowedExtension)
        ...
        if (fileNamelength > FileUploadUtils.DEFAULT_FILE_NAME_LENGTH) {
            throw new FileLimitException("上传文件大小不能超过" + FileUploadUtils.DEFAULT_FILE_NAME_LENGTH);
        }
    ...
    private static final String getPathFileName(String uploadDir, String fileName) throws IOException
    {
        ...
        String pathFileName = SysContants.RESOURCE_PREFIX + "/" + currentDir + "/" + fileName;
        return pathFileName;
    }
    ...
    public static final void assertAllowed(MultipartFile file, String[] allowedExtension)
            throws FileLimitException
    {
        long size = file.getSize();
        if (DEFAULT_MAX_SIZE != -1 && size > DEFAULT_MAX_SIZE)
        {
            throw new FileLimitException("文件大小不能超过" + DEFAULT_MAX_SIZE / 1024 / 1024);
        }
        ...
        if (allowedExtension != null && !isAllowedExtension(extension, allowedExtension))
        {
            ...
            {
                throw new FileLimitException("上传文件类型错误");
            }
